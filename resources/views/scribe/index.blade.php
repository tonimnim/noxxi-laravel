...
<form id="form-POSTapi-auth-register-organizer" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-auth-register-organizer');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-auth-register-organizer"
                    onclick="cancelTryOut('POSTapi-auth-register-organizer');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-auth-password-request-reset" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-auth-password-request-reset');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-auth-password-request-reset"
                    onclick="cancelTryOut('POSTapi-auth-password-request-reset');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-events-categories" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-events-categories');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-events-categories"
                    onclick="cancelTryOut('GETapi-events-categories');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-system-metrics" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-system-metrics');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-system-metrics"
                    onclick="cancelTryOut('GETapi-system-metrics');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-bookings--id--tickets" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-bookings--id--tickets');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-bookings--id--tickets"
                    onclick="cancelTryOut('GETapi-bookings--id--tickets');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-tickets-upcoming" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-tickets-upcoming');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-tickets-upcoming"
                    onclick="cancelTryOut('GETapi-tickets-upcoming');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-tickets-past" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-tickets-past');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-tickets-past"
                    onclick="cancelTryOut('GETapi-tickets-past');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-tickets-booking--bookingId-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-tickets-booking--bookingId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-tickets-booking--bookingId-"
                    onclick="cancelTryOut('GETapi-tickets-booking--bookingId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-tickets--id--transfer" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-tickets--id--transfer');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-tickets--id--transfer"
                    onclick="cancelTryOut('POSTapi-tickets--id--transfer');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-tickets--id--transfer-history" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-tickets--id--transfer-history');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-tickets--id--transfer-history"
                    onclick="cancelTryOut('GETapi-tickets--id--transfer-history');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-tickets--id--download" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-tickets--id--download');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-tickets--id--download"
                    onclick="cancelTryOut('GETapi-tickets--id--download');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-payments-paystack-initialize" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-payments-paystack-initialize');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-payments-paystack-initialize"
                    onclick="cancelTryOut('POSTapi-payments-paystack-initialize');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-payments-mpesa-initialize" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-payments-mpesa-initialize');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-payments-mpesa-initialize"
                    onclick="cancelTryOut('POSTapi-payments-mpesa-initialize');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-payments-verify--transactionId-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-payments-verify--transactionId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-payments-verify--transactionId-"
                    onclick="cancelTryOut('GETapi-payments-verify--transactionId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-payments-transactions" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-payments-transactions');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-payments-transactions"
                    onclick="cancelTryOut('GETapi-payments-transactions');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-refunds" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-refunds');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-refunds"
                    onclick="cancelTryOut('GETapi-refunds');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-refunds" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-refunds');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-refunds"
                    onclick="cancelTryOut('POSTapi-refunds');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-refunds--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-refunds--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-refunds--id-"
                    onclick="cancelTryOut('GETapi-refunds--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-refunds--id--cancel" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-refunds--id--cancel');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-refunds--id--cancel"
                    onclick="cancelTryOut('POSTapi-refunds--id--cancel');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-refunds-check-eligibility--bookingId-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-refunds-check-eligibility--bookingId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-refunds-check-eligibility--bookingId-"
                    onclick="cancelTryOut('GETapi-refunds-check-eligibility--bookingId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-organizer-listings" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-organizer-listings');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-organizer-listings"
                    onclick="cancelTryOut('GETapi-v1-organizer-listings');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-organizer-listings-create" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-organizer-listings-create');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-organizer-listings-create"
                    onclick="cancelTryOut('POSTapi-v1-organizer-listings-create');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-organizer-listings--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-organizer-listings--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-organizer-listings--id-"
                    onclick="cancelTryOut('GETapi-v1-organizer-listings--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PUTapi-v1-organizer-listings--id--update" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-v1-organizer-listings--id--update');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-organizer-listings--id--update"
                    onclick="cancelTryOut('PUTapi-v1-organizer-listings--id--update');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-organizer-listings--id--publish" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-organizer-listings--id--publish');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-organizer-listings--id--publish"
                    onclick="cancelTryOut('POSTapi-v1-organizer-listings--id--publish');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-DELETEapi-v1-organizer-listings--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-v1-organizer-listings--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-organizer-listings--id-"
                    onclick="cancelTryOut('DELETEapi-v1-organizer-listings--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-tickets-validate" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-tickets-validate');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-tickets-validate"
                    onclick="cancelTryOut('POSTapi-v1-tickets-validate');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-tickets-check-in" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-tickets-check-in');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-tickets-check-in"
                    onclick="cancelTryOut('POSTapi-v1-tickets-check-in');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-tickets-batch-validate" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-tickets-batch-validate');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-tickets-batch-validate"
                    onclick="cancelTryOut('POSTapi-v1-tickets-batch-validate');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-tickets-validate-by-code" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-tickets-validate-by-code');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-tickets-validate-by-code"
                    onclick="cancelTryOut('POSTapi-v1-tickets-validate-by-code');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-events--id--manifest" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-events--id--manifest');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-events--id--manifest"
                    onclick="cancelTryOut('GETapi-v1-events--id--manifest');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-events--id--check-in-stats" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-events--id--check-in-stats');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-events--id--check-in-stats"
                    onclick="cancelTryOut('GETapi-v1-events--id--check-in-stats');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-webhooks-paystack" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-webhooks-paystack');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-webhooks-paystack"
                    onclick="cancelTryOut('POSTapi-webhooks-paystack');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-webhooks-mpesa" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-webhooks-mpesa');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-webhooks-mpesa"
                    onclick="cancelTryOut('POSTapi-webhooks-mpesa');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
