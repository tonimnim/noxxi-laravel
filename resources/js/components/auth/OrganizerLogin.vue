    ...
    <div class="w-full max-w-md px-4 sm:px-6">
      <div class="bg-white py-8 px-6 shadow-lg rounded-lg sm:px-10">
        ...
        <div class="mb-8">
          ...
          <h2 class="mt-6 text-2xl font-semibold text-gray-900">Welcome back, Organizer</h2>
          <p class="mt-2 text-sm text-gray-600">
            New to organizing?
            <a href="/register/organizer" class="font-medium text-[#305F64] hover:text-[#204044] ml-1">
              Start your journey
            </a>
          </p>
        </div>
  ...
  try {
    ...
    if (data.status === 'success') {
      ...
      if (data.requires_verification) {
        ...
        window.location.href = data.redirect || '/organizer/dashboard'
      }
    } else {
