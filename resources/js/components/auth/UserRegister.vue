    ...
    <div class="w-full max-w-md px-4 sm:px-6">
      <div class="bg-white py-8 px-6 shadow-lg rounded-lg sm:px-10">
        ...
        <div class="mb-8">
          ...
          <h2 class="mt-6 text-2xl font-semibold text-gray-900 text-center">Create your account</h2>
        ...
        <form class="space-y-5" @submit.prevent="handleRegister">
          ...
          <div class="flex items-start">
            ...
            <label for="terms" class="ml-2 block text-sm text-gray-700">
              ...
              and
              <a href="/privacy" class="font-medium text-[#305F64] hover:text-[#204044]">Privacy Policy</a>
            </label>
          </div>
          ...
          <div>
            <button
              type="submit"
              :disabled="loading || !form.full_name || !form.email || !form.password || !form.terms"
          ...
          <div class="text-center mt-6">
            <p class="text-sm text-gray-600">
              ...
              <a href="/login" class="font-medium text-[#305F64] hover:text-[#204044]">
                Sign in
              </a>
            </p>
          </div>
          ...
          <div class="text-center">
            <p class="text-sm text-gray-600">
              ...
              <a href="/register/organizer" class="font-medium text-amber-600 hover:text-amber-500">
...
const handleRegister = async () => {
  ...
  // If phone was provided but invalid, show error
  if (form.value.phone_number && phoneValidation.value && !phoneValidation.value.isValid) {
  ...
  if (!form.value.phone_number) {
    form.value.phone_number = '+000' + Date.now().toString().slice(-10)
  }
  ...
  try {
    const response = await fetch('/auth/web/register', {
      method: 'POST',
      headers: {
      ...
      body: JSON.stringify({
        ...
        redirect: redirectParam // Pass redirect parameter if present
      }),
